...

{
 ...
 cout << "Press 1 to perform algebric calculations" << endl;
 cout << "Press 2 to perform trignometric values of entered degrees" << endl;
 cout << "Press 3 to perform exponential calculations" << endl;
 cout << "Press 4 to perform trignometric calculations" << endl;
